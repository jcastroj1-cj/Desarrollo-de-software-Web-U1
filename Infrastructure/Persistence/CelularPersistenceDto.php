...
class CelularPersistenceDto {
    ...
    public function __construct(
        ?int $id, string $marca, string $imei, float $pulgadas, float $megapixeles,
        int $ram, int $almacenamientoPrincipal, int $almacenamientoSecundario,
        string $sistemaOperativo, string $operador, string $tecnologiaBanda,
        int $wifi, int $bluetooth, int $camaras, string $marcaCpu, float $velocidadCpu,
        int $nfc, int $huella, int $ir, int $resisteAgua, int $cantidadSim
    ) {
        $this->id = $id;
        $this->marca = $marca;
        $this->imei = $imei;
